...
const stages = [
  {
  title: '1. К тюльпановому дереву и водопадам',
  description: 'Сбор группы, посадка в джипы, выезд по живописной дороге вдоль реки Шахе. По пути — остановка у знаменитого тюльпанового дерева.',
  image: img1,
},
  {
